...
// #if TARGET_OS_IPHONE
// /**
//  * @brief 设置自适应视频配置后，推流端根据配置参数和设备资源（包括：CPU 资源和当前占用情况、内存资源和当前占用情况、电池电量等）自动选择合适的编码参数（包含：编码分辨率、编码帧率）。
//  * 
//  * @attention 必须在 initSDK 前调用。
//  * @attention 默认不设置自适应视频配置。
//  * @param config 自适应视频配置。
//  * @return 0 表示成功，-1 为失败
//  */
// + (void)setAdaptiveVideoConfig:(ZegoAdaptiveVideoConfig *)config;
// #endif
@end
...
/**
 ...
 @attention 以 RTC 或 L3 方式拉流，且对应推流用户和本地用户在同一房间内，会收到对应用户的网络质量
