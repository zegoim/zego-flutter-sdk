...
class ZegoAudioplayer {
  ...
  static Future<int> play(int soundID, {
    ...
    final Map<dynamic, dynamic> errorMsg = await _channel.invokeMethod('playAudioEffect', {
      'soundID': soundID,
      'path': sourcePath,
  ...
  static Future<void> stop(int soundID) async {
    return await _channel.invokeMethod('stopAudioEffect', {
      'soundID': soundID
    });
  }
  ...
  static Future<void> pause(int soundID) async {
    return await _channel.invokeMethod('pauseAudioEffect', {
      'soundID': soundID
    });
  }
  ...
  static Future<void> resume(int soundID) async {
    return await _channel.invokeMethod('resumeAudioEffect', {
      'soundID': soundID
    });
  }
  ...
  static Future<int> preload(int soundID, String sourcePath, {
    bool isAssetPath = true,
  }) async {

    final Map<dynamic, dynamic> errorMsg = await _channel.invokeMethod('preloadAudioEffect', {
      'soundID': soundID,
      'path': sourcePath,
      'isAssetPath': isAssetPath
    });
  ...
  static Future<void> unload(int soundID) async {
    return await _channel.invokeMethod('unloadAudioEffect', {
      'soundID': soundID
    });
  }
  ...
  static Future<void> setVolume(int soundID, int volume) async {
    return await _channel.invokeMethod('setAudioEffectVolume', {
      'soundID': soundID,
      'volume': volume
    });
  }
  ...
  static Future<void> setAllVolume(int volume) async {
    return await _channel.invokeMethod('setAllAudioEffectVolume', {
      'volume': volume
    });
  }
  ...
  static Future<void> registerAudioPlayerCallback(
    Function(int soundID) onAudioPlayEnd) async {
    ...
    if(_streamSubscription == null)
      _streamSubscription = ZegoLiveRoomEventChannel.listenAudioPlayerEvent().listen(_eventListener);
  }
