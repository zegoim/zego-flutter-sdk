...
class PublishStreamPlatformViewPage extends StatefulWidget {
  ...
  @override
  _PublishStreamPlatformViewPageState createState() => new _PublishStreamPlatformViewPageState();
}

class _PublishStreamPlatformViewPageState extends State<PublishStreamPlatformViewPage> {
  ...
  void initState() {
    ...
    _publishView = ZegoLiveRoomPublisherPlugin.createPreviewPlatformView((int viewID) {
