...
class PlayStreamPlatformViewPage extends StatefulWidget {
  ...
  @override
  _PlayStreamPlatformViewPageState createState() =>
      new _PlayStreamPlatformViewPageState();
}

class _PlayStreamPlatformViewPageState
    extends State<PlayStreamPlatformViewPage> {
  String _title = '';
  int _viewID = -1;
  ...
  void onPlayButtonPressed() {
    ...
    setState(() {
      _playView = ZegoLiveRoomPlayerPlugin.createPlayPlatformView(streamID,
          (int viewID) {
        print('platform view created, id: $viewID');
        _viewID = viewID;
        ZegoLiveRoomPlayerPlugin.startPlayingStream(streamID, viewID: _viewID)
            .then((success) {
          ZegoLiveRoomPlayerPlugin.setPlatformViewPlayViewMode(
